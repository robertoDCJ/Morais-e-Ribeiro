      ...
      <main className="bg-gray-200">
        <div className="flex flex-col justify-center">
          <div
            ...
            style={{
              backgroundImage:
                "url('/ImgAreasDeAtuacao/direito-previdenciario.svg')",
              height: "359px",
        ...
        <div className="text-xl font-medium text-black">
          ...
          <p className="text-black font-Lato p-4">
            ...
            >
              <strong>Instituto Nacional do Seguro Social (INSS)</strong>
            </Link>
            , responsável pela manutenção da previdência social pública do
            Brasil. Ele regula as relações entre empresas e empregados com os
            órgãos da previdência
            <strong> social</strong> ou <strong>privada</strong>.
          </p>
          <p className="font-light text-black font-Lato p-4">
            A reforma da previdência trouxe mudanças importantes na forma com
            que a previdência social funciona, aumentando a importância do
            direito previdenciário para advogados que lidem com questões civis e
            do direito público. Essas mudanças impactam pessoas que podem estar
            contribuindo há décadas para a previdência social.
          </p>
          <p className="text-black font-Lato p-4">
            O direito previdenciário é considerado um direito fundamental,
            defendendo o direito do cidadão a ter acesso aos seus direitos
            constitucionais. Ele é um direito social brasileiro, firmado pela
            <Link
          ...
          <p className="font-light text-black font-Lato p-4 pb-5">
            ...
            próprios, o direito previdenciário também possui alguns. Trata-se,
            portanto, de conceitos e preceitos basilares para a constituição
            dessa área jurídica.
          </p>
        </div>
      </main>
