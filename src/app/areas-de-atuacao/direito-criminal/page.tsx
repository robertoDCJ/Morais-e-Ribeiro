      ...
      <main className="bg-gray-200">
        <div className="flex flex-col justify-center">
          <div
            ...
            style={{
              backgroundImage: "url('/ImgAreasDeAtuacao/direito-criminal.svg')",
              height: "359px",
        ...
        <div className="text-xl font-medium text-black">
          ...
          <p className="font-light text-black font-Lato p-4">
            O direito criminal, também conhecido como direito penal, é uma área
            do direito que lida com o comportamento considerado ilegal pelo
            Estado. Ele é projetado para prevenir e punir atos que são
          ...
          <p className="text-black font-Lato p-4">
            A <strong>presunção de inocência</strong> é um princípio fundamental
            no direito criminal. Isso significa que uma pessoa acusada de um
            crime é considerada inocente até que seja provada sua culpa. O ônus
            da prova recai sobre a acusação, que deve provar a culpa do acusado
          ...
          <p className="text-black font-Lato p-4">
            O direito criminal é um campo em constante evolução, com novas leis
            sendo introduzidas e antigas sendo revisadas ou revogadas. É
            essencial para os profissionais do direito manterem-se atualizados
            sobre as últimas mudanças na legislação e na jurisprudência.
          </p>
          <p className="text-black font-Lato p-4 pb-5">
            Desempenha um papel vital na manutenção da ordem e da justiça na
            sociedade. Ele protege os direitos dos indivíduos e serve como um
            dissuasor para aqueles que consideram cometer atos ilegais.
          </p>
        </div>
      </main>
    </>
