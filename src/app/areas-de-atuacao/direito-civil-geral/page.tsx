export default function DireitoCivilGeral() {
  return (
    <>
      <main className="bg-gray-200">
        <div className="flex flex-col justify-center">
          <div
            ...
            style={{
              backgroundImage:
                "url('/ImgAreasDeAtuacao/direito-civil-geral.svg')",
              height: "359px",
        ...
        <div className="text-xl font-medium text-black">
          <h1 className="text-2xl font-bold text-black pb-2 ml-5 mt-5">
            Entendendo o Direito Civil: Uma Perspectiva Abrangente
          </h1>
          <p className="font-light text-black font-Lato p-4">
            O Direito Civil, frequentemente referido como o direito do cidadão,
            é uma das principais vertentes do Direito, atuando como a coluna
            vertebral da ordem jurídica em muitos países. Ele engloba as normas
            fundamentais que regem a vida em sociedade, abordando os direitos e
            obrigações de todos os indivíduos.
          </p>

          <h2 className="text-2xl font-bold text-black pb-2 ml-5 ">
            A Essência do Direito Civil
          </h2>
          ...
          <h2 className="text-2xl font-bold text-black pb-2 ml-5">
            Contratos no Âmbito do Direito Civil
          </h2>
          <p className="font-light text-black font-Lato p-4">
            O contrato é um acordo de vontades entre as partes. Complementando
            esse conceito, o contrato é usualmente definido como o acordo de
            vontades destinado a criar, modificar ou extinguir obrigações.
          </p>

          <h2 className="text-2xl font-bold text-black pb-2 ml-5">
            Os Desafios do Direito Civil
          </h2>
