      ...
      <main className="bg-gray-200">
        <div className="flex flex-col justify-center">
          <div
            ...
            style={{
              backgroundImage:
                "url('/ImgAreasDeAtuacao/direito-do-consumidor.svg')",
              height: "359px",
        ...
        <div className="text-xl font-medium text-black">
          ...
          <p className="text-black font-Lato p-4">
            O Direito do Consumidor é uma ramificação do Direito que se dedica a
            proteger os consumidores nas relações de consumo. Ele regula as
            interações entre
            <strong> consumidores</strong> e <strong>fornecedores</strong>,
            sejam eles de
          ...
          <p className="text-black font-Lato p-4">
            ...
            >
              <strong> Código de Defesa do Consumidor (CDC)</strong>
            </Link>
            , estabelecido em 1990. O CDC é um conjunto de normas que visam
            proteger e defender o consumidor, sendo considerado de ordem pública
            e interesse social.
          </p>
          ...
          <ul className="list-disc pl-9 text-black pr-5">
            <li>
              ...
              Os consumidores têm o direito de comprar apenas a quantidade de um
              produto que precisam, sem serem obrigados a comprar um pacote
              inteiro.
            </li>
            <li>
              <strong>Perda da nota fiscal:</strong> Se um consumidor perder uma
              nota fiscal, ele pode solicitar uma segunda via ao estabelecimento
              onde a compra foi feita ou ao prestador de serviço.
            </li>
            <li>
              <strong>Venda casada:</strong> É ilegal forçar um consumidor a
              comprar um produto ou serviço como condição para comprar outro.
            </li>
            <li>
              <strong>Produto com preços diferentes:</strong> Se um produto
              tiver dois preços diferentes, o menor preço deve prevalecer.
            </li>
            <li>
              <strong>Queda de energia:</strong> Danos causados por queda de
              energia devem ser reparados pelo fornecedor de energia.
            </li>
            <li>
              <strong>Custeio de medicamentos:</strong> As operadoras de saúde
              devem fornecer todo o tratamento necessário aos pacientes,
              incluindo a cobertura de medicamentos.
            </li>
            <li>
              <strong>Comida no cinema:</strong> Os cinemas não podem obrigar os
              consumidores a comprar alimentos e bebidas em suas lojas internas.
            </li>
            <li>
              <strong>Mala extraviada:</strong> Se uma mala for extraviada
              durante um voo, a companhia aérea tem um prazo máximo para
              encontrá-la e enviá-la ao endereço informado pelo passageiro.
            </li>
          </ul>

          <p className="text-black font-Lato p-4 pb-5">
            Esses são apenas alguns exemplos dos direitos dos consumidores. É
            essencial que todos os consumidores conheçam seus direitos e os
