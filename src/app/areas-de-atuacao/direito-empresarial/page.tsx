      ...
      <main className="bg-gray-200">
        <div className="flex flex-col justify-center">
          <div
            ...
            style={{
              backgroundImage:
                "url('/ImgAreasDeAtuacao/direito-empresarial.svg')",
              height: "359px",
        ...
        <div className="text-xl font-medium text-black">
          ...
          <p className="font-light text-black font-Lato p-4">
            O Direito Empresarial, também conhecido como Direito Comercial, é um
            ramo do Direito Privado que se dedica ao estudo e regulamentação das
            relações entre empresários, empresas e o mercado.
          </p>
          <p className="font-light text-black font-Lato p-4">
            Este campo do direito abrange um conjunto específico de normas
            (regras e princípios) que disciplinam a atividade econômica
            organizada para a produção ou circulação de bens ou serviços. Em
            outras palavras, o Direito Empresarial é responsável por resolver
            conflitos de interesses envolvendo empresários ou relacionados às
            empresas que eles exploram.
          </p>
          ...
          <p className=" text-black font-Lato p-4">
            Se distingue do Direito Civil por se fundamentar numa principiologia
            ...
            , mais precisamente em seu <strong>art. 170.</strong>
          </p>
          <p className="mb-font-light text-black font-Lato p-4 pb-5">
            O Direito Empresarial é um campo crucial para a saúde econômica e o
            desenvolvimento de um país, estruturando a organização empresarial
            moderna e regulando o status legal do empreendedor.
          </p>
        </div>
      </main>
    </>
